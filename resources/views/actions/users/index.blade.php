<div class="flex items-center justify-end space-x-2">
    ...
    @can('conversations', App\Models\User::class)
        ...
        <a href="{{ route('conversations.index', $row->id) }}" class="inline-flex items-center px-2 py-1 text-xs font-medium text-purple-600 bg-purple-100 rounded hover:bg-purple-200 transition-colors duration-200" title="View Conversations">
            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">

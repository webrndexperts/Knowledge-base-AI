                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <nav class="flex mb-6" aria-label="Breadcrumb">
                        <ol class="flex items-center space-x-4">
                            <li>
                                <a href="{{ route('conversations.index') }}" class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('conversations.index') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                                        Conversations
                                    </a>
                                </div>
                            </li>
